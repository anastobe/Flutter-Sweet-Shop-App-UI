...
import { useRequestPendingcardLimitChangeViewModel } from '../../../viewModels/homeViewModel/home/useRequestPendingcardLimitChangeViewModel';
import { CommonUtils } from '../../../utils';
import { Auth_ROUTES } from '../../../constants';


export default function RequestPendingcardLimitChange() {
 const {
   pressBackArrow,
   open,
   onRefresh,
 ...
 } = useRequestPendingcardLimitChangeViewModel();
 ...
 return (
    ...
    <Text style={styles.title}>Pending card limit change request</Text>
