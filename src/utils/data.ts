...
const PAYMENT_OPTION = [
  ...
  { id: '2', name: 'International Transfer', detailTxt: 'Send payments across borders in multiple currencies.', icon: Images.international, route: HOME_ROUTES.CURRENCY_EXCHANGE, key: "international"  },
  { id: '3', name: 'To My Account', detailTxt: 'Move money between your own accounts.', icon: Images.toMyAcc, route: HOME_ROUTES.CURRENCY_EXCHANGE, key: "myaccount"  }
];
